(function () {
    ...
    var mapTypes = [{
        ...
        {
            name: "G1 - Population by geozone, age and sex",
            id: "G1"
        },
        {
            name: "G2 - Native-born and foreign-born population by geozone and sex",
            id: "G2"
        },
        {
            name: "G3 - Population by geozone, nationality and sex",
            id: "G3"
        }
    ];
    ...
    dropdown.selectAll('option')
        .data(mapTypes, function (d) {
            return d.id ? d.name : this.id;
        }).enter() // attach our array as data
        ...
        var dataLayer = L.geoJson(data, {
            ...
            onEachFeature: function (feature, layer) {
                if (feature.properties) {
                    ...
                    layer.setStyle({
                        fillColor: colorize(Number(content))
                    });
